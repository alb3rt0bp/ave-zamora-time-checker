...
from renfe_client import RenfeClient, FLOTA_URL
...
class TestFetch(unittest.TestCase):
    ...
    def test_returns_raw_bytes_on_success(self, mock_urlopen):
        ...
        result = self.client._fetch(FLOTA_URL)
    ...
    def test_uses_configured_timeout(self, mock_urlopen):
        ...
        client = RenfeClient(SAMPLE_LOG_EXTRA, timeout_seconds=7)

        client._fetch(FLOTA_URL)
